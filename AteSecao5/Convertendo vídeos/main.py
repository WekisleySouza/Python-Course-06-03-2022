...
caminho_origem = r"C:\Users\wekis\Desktop\Python\Python - Udemy"
caminho_destino = r"C:\Users\wekis\Desktop\Python\Python - Udemy"
...
for raiz, pastas, arquivos in os.walk(caminho_origem):
    for arquivo in arquivos:
        ...
        if os.path.isfile(caminho_legenda):
            ...
            map_legenda = f'-c:s srt -map v:0 -map a -map 1:0'
        else:
            input_legenda = ''
            map_legenda =''
